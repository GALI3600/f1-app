...
class AppTheme {
  ...
  /// Minimalist dark theme inspired by official F1 app
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.dark(
        primary: F1Colors.vermelho,
        secondary: F1Colors.vermelho,
        tertiary: F1Colors.textSecondary,
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        ...
        selectedItemColor: F1Colors.vermelho,
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(8),
          borderSide: const BorderSide(color: F1Colors.border),
        ),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(8),
          side: const BorderSide(color: F1Colors.border),
        ),
      ...
      checkboxTheme: CheckboxThemeData(
        ...
        side: const BorderSide(color: F1Colors.vermelho, width: 2),
      ),
      ...
      sliderTheme: const SliderThemeData(
        activeTrackColor: F1Colors.vermelho,
        inactiveTrackColor: F1Colors.navy,
        thumbColor: F1Colors.vermelho,
        overlayColor: Color(0x1FE10600),
        valueIndicatorColor: F1Colors.vermelho,
        valueIndicatorTextStyle: TextStyle(color: Colors.white),
      ),

      // ========== TabBar ==========
      tabBarTheme: const TabBarThemeData(
        labelColor: F1Colors.vermelho,
        unselectedLabelColor: F1Colors.textSecondary,
        indicatorColor: F1Colors.vermelho,
